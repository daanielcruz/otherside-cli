...
import { ensurePeersDir, peerPath, peersDir } from "@/remote/_infra/paths.ts";
import { registerEnvironment, unpair } from "@/remote/backend/api.ts";
import { clearAuth, currentUserId, loadFreshAuth } from "@/remote/backend/auth.ts";
import type { Bytes } from "@/remote/crypto/e2ee.ts";
import { b64uDecode, b64uEncode } from "@/remote/crypto/e2ee.ts";
import { setRemoteEnabled } from "@/remote/session/state.ts";
import {
  deviceFingerprint,
  dropCurrentDevice,
  ensureDevice,
