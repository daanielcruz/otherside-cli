...
import * as realLifecycle from "@/engine/background/subagents/lifecycle.ts";
...
const lifecycleExports = { ...realLifecycle };
...
afterAll(() => {
  mock.module("@/engine/background/subagents/lifecycle.ts", () => lifecycleExports);
});
