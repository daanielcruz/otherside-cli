...
#[test]
#[ignore = "fingerprint_corpus/tools-glob-single was captured at 2.1.113.3e2; assembly now emits 2.1.118.3c3. Re-capture tools-glob-single scenario at 2.1.118 to re-enable."]
